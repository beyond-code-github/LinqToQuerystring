namespace LinqToQueryString.IntegrationTests
{
    ...
    {
        private Because of = () => result = testDb.ConcreteCollection.ExtendFromOData("?$filter=Name eq 'Apple'").ToList();
    ...
    {
        private Because of = () => result = testDb.ConcreteCollection.ExtendFromOData("?$filter=not Name eq 'Apple'").ToList();
    ...
    {
        private Because of = () => result = testDb.ConcreteCollection.ExtendFromOData("?$filter=Name ne 'Apple'").ToList();
    ...
    {
        private Because of = () => result = testDb.ConcreteCollection.ExtendFromOData("?$filter=not Name ne 'Apple'").ToList();
    ...
    {
        private Because of = () => result = testDb.ConcreteCollection.ExtendFromOData("?$filter=Age eq 4").ToList();
    ...
    {
        private Because of = () => result = testDb.ConcreteCollection.ExtendFromOData("?$filter=not Age eq 4").ToList();
    ...
    {
        private Because of = () => result = testDb.ConcreteCollection.ExtendFromOData("?$filter=Age ne 4").ToList();
    ...
    {
        private Because of = () => result = testDb.ConcreteCollection.ExtendFromOData("?$filter=not Age ne 4").ToList();
    ...
    {
        private Because of = () => result = testDb.ConcreteCollection.ExtendFromOData("?$filter=Age gt 3").ToList();
    ...
    {
        private Because of = () => result = testDb.ConcreteCollection.ExtendFromOData("?$filter=not Age gt 3").ToList();
    ...
    {
        private Because of = () => result = testDb.ConcreteCollection.ExtendFromOData("?$filter=Age ge 3").ToList();
    ...
    {
        private Because of = () => result = testDb.ConcreteCollection.ExtendFromOData("?$filter=not Age ge 3").ToList();
    ...
    {
        private Because of = () => result = testDb.ConcreteCollection.ExtendFromOData("?$filter=Age lt 3").ToList();
    ...
    {
        private Because of = () => result = testDb.ConcreteCollection.ExtendFromOData("?$filter=not Age lt 3").ToList();
    ...
    {
        private Because of = () => result = testDb.ConcreteCollection.ExtendFromOData("?$filter=Age le 3").ToList();
    ...
    {
        private Because of = () => result = testDb.ConcreteCollection.ExtendFromOData("?$filter=not Age le 3").ToList();
    ...
    {
        private Because of = () => result = testDb.ConcreteCollection.ExtendFromOData("?$filter=Date eq datetime'2002-01-01T00:00'").ToList();
    ...
    {
        private Because of = () => result = testDb.ConcreteCollection.ExtendFromOData("?$filter=not Date eq datetime'2002-01-01T00:00'").ToList();
    ...
    {
        private Because of = () => result = testDb.ConcreteCollection.ExtendFromOData("?$filter=Date ne datetime'2002-01-01T00:00'").ToList();
    ...
    {
        private Because of = () => result = testDb.ConcreteCollection.ExtendFromOData("?$filter=not Date ne datetime'2002-01-01T00:00'").ToList();
    ...
    {
        private Because of = () => result = testDb.ConcreteCollection.ExtendFromOData("?$filter=Date gt datetime'2003-01-01T00:00'").ToList();
    ...
    {
        private Because of = () => result = testDb.ConcreteCollection.ExtendFromOData("?$filter=not Date gt datetime'2003-01-01T00:00'").ToList();
    ...
    {
        private Because of = () => result = testDb.ConcreteCollection.ExtendFromOData("?$filter=Date ge datetime'2003-01-01T00:00'").ToList();
    ...
    {
        private Because of = () => result = testDb.ConcreteCollection.ExtendFromOData("?$filter=not Date ge datetime'2003-01-01T00:00'").ToList();
    ...
    {
        private Because of = () => result = testDb.ConcreteCollection.ExtendFromOData("?$filter=Date lt datetime'2003-01-01T00:00'").ToList();
    ...
    {
        private Because of = () => result = testDb.ConcreteCollection.ExtendFromOData("?$filter=not Date lt datetime'2003-01-01T00:00'").ToList();
    ...
    {
        private Because of = () => result = testDb.ConcreteCollection.ExtendFromOData("?$filter=Date le datetime'2003-01-01T00:00'").ToList();
    ...
    {
        private Because of = () => result = testDb.ConcreteCollection.ExtendFromOData("?$filter=not Date le datetime'2003-01-01T00:00'").ToList();
    ...
    {
        private Because of = () => result = testDb.ConcreteCollection.ExtendFromOData("?$filter=Complete eq true").ToList();
    ...
    {
        private Because of = () => result = testDb.ConcreteCollection.ExtendFromOData("?$filter=not Complete eq true").ToList();
    ...
    {
        private Because of = () => result = testDb.ConcreteCollection.ExtendFromOData("?$filter=Complete ne true").ToList();
    ...
    {
        private Because of = () => result = testDb.ConcreteCollection.ExtendFromOData("?$filter=not Complete ne true").ToList();
    ...
    {
        private Because of =
            () => result = testDb.ConcreteCollection.ExtendFromOData("?$filter=Name eq 'Custard' and Age ge 2").ToList();
    ...
    {
        private Because of =
            () => result = testDb.ConcreteCollection.ExtendFromOData("?$filter=Name eq 'Custard' and not Age lt 2").ToList();
    ...
    {
        private Because of =
            () => result = testDb.ConcreteCollection.ExtendFromOData("?$filter=Name eq 'Banana' or Date gt datetime'2003-01-01T00:00'").ToList();
    ...
    {
        private Because of =
            () => result = testDb.ConcreteCollection.ExtendFromOData("?$filter=Name eq 'Banana' or not Date le datetime'2003-01-01T00:00'").ToList();
    ...
    {
        private Because of =
            () => result = testDb.ConcreteCollection.ExtendFromOData("?$filter=Name eq 'Apple' and Complete eq true or Date gt datetime'2003-01-01T00:00'").ToList();
    ...
    {
        private Because of =
            () => result = testDb.ConcreteCollection.ExtendFromOData("?$filter=Name eq 'Apple' and Complete eq true or not Date le datetime'2003-01-01T00:00'").ToList();
    ...
    {
        private Because of =
            () => result = testDb.ConcreteCollection.ExtendFromOData("?$filter=not (Name eq 'Apple' and (Complete eq true or Date gt datetime'2003-01-01T00:00'))").ToList();
