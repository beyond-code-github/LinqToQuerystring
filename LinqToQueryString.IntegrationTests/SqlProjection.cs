namespace LinqToQueryString.IntegrationTests
{
    ...
    public class When_selecting_a_single_string_property : SqlProjection
    {
        private Because of =
            () =>
            result = testDb.ConcreteCollection.ExtendFromOData<ConcreteClass, Dictionary<string, object>>("?$select=Name").ToList();
    ...
    public class When_selecting_a_single_int_property : SqlProjection
    {
        private Because of =
            () =>
            result = testDb.ConcreteCollection.ExtendFromOData<ConcreteClass, Dictionary<string, object>>("?$select=Age").ToList();
    ...
    public class When_selecting_a_single_datetime_property : SqlProjection
    {
        private Because of =
            () =>
            result = testDb.ConcreteCollection.ExtendFromOData<ConcreteClass, Dictionary<string, object>>("?$select=Date").ToList();
    ...
    public class When_selecting_a_single_boolean_property : SqlProjection
    {
        private Because of =
            () =>
            result = testDb.ConcreteCollection.ExtendFromOData<ConcreteClass, Dictionary<string, object>>("?$select=Complete").ToList();
    ...
    public class When_selecting_multiple_properties : SqlProjection
    {
        private Because of =
            () =>
            result = testDb.ConcreteCollection.ExtendFromOData<ConcreteClass, Dictionary<string, object>>("?$select=Name,Age").ToList();
