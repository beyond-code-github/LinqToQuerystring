namespace LinqToQueryString.UnitTests
{
    ...
    public class When_selecting_a_single_string_property : Projection
    {
        private Because of =
            () =>
            result = concreteCollection.AsQueryable().ExtendFromOData<ConcreteClass, Dictionary<string, object>>("?$select=Name");
    ...
    public class When_selecting_a_single_int_property : Projection
    {
        private Because of =
            () =>
            result = concreteCollection.AsQueryable().ExtendFromOData<ConcreteClass, Dictionary<string, object>>("?$select=Age");
    ...
    public class When_selecting_a_single_datetime_property : Projection
    {
        private Because of =
            () =>
            result = concreteCollection.AsQueryable().ExtendFromOData<ConcreteClass, Dictionary<string, object>>("?$select=Date");
    ...
    public class When_selecting_a_single_boolean_property : Projection
    {
        private Because of =
            () =>
            result = concreteCollection.AsQueryable().ExtendFromOData<ConcreteClass, Dictionary<string, object>>("?$select=Complete");
    ...
    public class When_selecting_multiple_properties : Projection
    {
        private Because of =
            () =>
            result = concreteCollection.AsQueryable().ExtendFromOData<ConcreteClass, Dictionary<string, object>>("?$select=Name,Age");
